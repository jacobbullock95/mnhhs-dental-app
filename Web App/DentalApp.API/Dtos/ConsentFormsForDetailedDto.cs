...
{
    public class ConsentFormsForDetailedDto
    {
        ...
        public DateTime HealthcareExpiry { get; set; }

        public string ChildMedicareNumber { get; set; }

        public string ChildMedicareCode { get; set; }

        public DateTime ChildMedicareExpiry { get; set; }
        ...
        public DateTime SignedDate2 { get; set; }
        ...
        public DateTime PtYear { get; set; }
        ...
        public DateTime SignedDate3 { get; set; }
    }
}